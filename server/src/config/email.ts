        ...
        case "appointment":
            mailOptions = {
                ...
                html: `
                    ...
                    <p>Nếu cần thay đổi lịch hẹn, vui lòng liên hệ hotline: <strong>0905 560 643</strong></p>
        ...
        case "appointment_rejected":
            mailOptions = {
                ...
                html: `
                        ...
                        <p>Nếu bạn cần hỗ trợ hoặc muốn đặt lại lịch hẹn, vui lòng liên hệ chúng tôi qua hotline: <strong>0905 560 643</strong>.</p>
